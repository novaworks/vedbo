...
$class = array('product_item', 'product-grid-item', 'grid-item', 'product');

$loop_index 	= wc_get_loop_prop('loop', 0);
$item_sizes     = wc_get_loop_prop('item_sizes', array());
$item_w         = 1;
$item_h         = 1;
$item_border_bottom = "yes";
$item_border_right = "yes";
...
if(!empty($item_sizes[$loop_index2]['border_bottom'])) {
    $item_border_bottom = "no" ;
}
if(!empty($item_sizes[$loop_index2]['border_right'])) {
    $item_border_right = "no" ;
}
?>

<li <?php function_exists('wc_product_class')? wc_product_class( $class, get_the_ID() ) : post_class('product'); ?> data-width="<?php echo esc_attr($item_w);?>" data-height="<?php echo esc_attr($item_h);?>" data-border_bottom="<?php echo esc_attr($item_border_bottom);?>" data-border_right="<?php echo esc_attr($item_border_right);?>">
