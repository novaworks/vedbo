...
Kirki::add_section( 'style_callout', array(
    'title'          => esc_html__( 'Callout', 'vedbo' ),
    'priority'       => 10,
    'capability'     => 'edit_theme_options',
    'panel'          => 'panel_styles'
) );
...
Kirki::add_section( 'style_main_menu', array(
    'title'          => esc_html__( 'Main Menu', 'vedbo' ),
    'priority'       => 10,
    'capability'     => 'edit_theme_options',
    'panel'          => 'panel_styles'
) );
...
Kirki::add_section( 'style_dropdowns', array(
    'title'          => esc_html__( 'Dropdown', 'vedbo' ),
    'priority'       => 10,
    'capability'     => 'edit_theme_options',
    'panel'          => 'panel_styles'
) );
...
Kirki::add_section( 'style_quick_view', array(
    'title'          => esc_html__( 'Quick View', 'vedbo' ),
    'priority'       => 10,
    'capability'     => 'edit_theme_options',
    'panel'          => 'panel_styles'
) );
