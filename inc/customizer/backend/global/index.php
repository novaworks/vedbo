...
Kirki::add_field( 'vedbo', array(
    'type'        => 'slider',
    'settings'    => 'site_width',
    'label'       => esc_html__( 'Site Width', 'vedbo' ),
    'section'     => $section,
    'default'     => 1440,
    'priority'    => 10,
    'choices'     => array(
...
Kirki::add_field( 'vedbo', array(
    ...
    'label'       => esc_html__( 'Site Preloader', 'vedbo' ),
    'section'     => $section,
    'default'     => false,
    'priority'    => 10,
) );
...
Kirki::add_field( 'vedbo', array(
    ...
    'label'       => esc_html__( 'Site Support List', 'vedbo' ),
    'section'     => $section,
    'default'     => false,
    'priority'    => 10,
) );
...
Kirki::add_field( 'vedbo', array(
    ...
    'label'       => esc_html__( 'Chat Link', 'vedbo' ),
    'section'     => $section,
...
Kirki::add_field( 'vedbo', array(
    ...
    'label'       => esc_html__( 'Phone Link', 'vedbo' ),
    'section'     => $section,
    'default'     => 'https://themeforest.ticksy.com/',
    'priority'    => 10,
    'active_callback'    => array(
...
Kirki::add_field( 'vedbo', array(
    ...
    'label'       => esc_html__( 'Email Address', 'vedbo' ),
    'section'     => $section,
...
Kirki::add_section( 'global_popup', array(
    'title'          => esc_html__( 'Newsletter Popup', 'vedbo' ),
    'priority'       => 10,
    'capability'     => 'edit_theme_options',
    'section'          => 'global',
) );
